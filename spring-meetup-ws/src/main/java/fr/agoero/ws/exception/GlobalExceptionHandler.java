...
import static fr.agoero.core.util.ValidationUtil.*;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Handler de l'exception {@link AccessDeniedException}
     * Si erreur de sécurité au niveau méthode, il faut re throw pour aller dans le handle de CustomAccessDeniedHandler
     *
     * @param accessDeniedException
     */
    @ExceptionHandler(AccessDeniedException.class)
    void handleAccessDeniedException(AccessDeniedException accessDeniedException) {
